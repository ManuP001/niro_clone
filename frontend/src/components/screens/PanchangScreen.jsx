      ...
      <div className="px-4 mb-4">
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4">
          <div className="grid grid-cols-2 gap-4 mb-4">
            <TimeCard icon={<Sunrise className="w-4 h-4 text-teal-500" />} label="Sunrise" value={panchangData.sunrise} />
            <TimeCard icon={<Sunset className="w-4 h-4 text-teal-600" />} label="Sunset" value={panchangData.sunset} />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <TimeCard icon={<Sun className="w-4 h-4 text-emerald-600" />} label="Sun sign" value={panchangData.sunSign} />
