          ...
          <div className="text-center">
            <div className="relative">
              <img
                ...
                className="w-16 h-16 rounded-full border-4 border-emerald-400"
              />
              <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-[10px] px-2 py-0.5 rounded-full">
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <button 
              ...
              className="mt-4 text-xs text-green-600 font-medium flex items-center gap-1 mx-auto hover:text-green-700"
            >
              ...
              <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  className={`h-full rounded-full transition-all duration-500 ${
                    ...
                    score.score >= 80 ? 'bg-emerald-600' : 'bg-teal-500'
                  }`}
