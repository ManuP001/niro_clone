...
/**
 * AppFooter - Reusable footer for authenticated screens
 * Shows Niro branding, disclaimer, and helpful links
 */
export default function AppFooter({ onNavigate }) {
  return (
    <footer 
      className="py-8 md:py-12 px-6 md:px-8 hidden md:block"
      style={{ 
    ...
    >
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Links */}
          <div className="flex items-center gap-6 text-sm" style={{ color: colors.text.muted }}>
            <button 
