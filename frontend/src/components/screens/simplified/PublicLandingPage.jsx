  ...
  return (
    <>
      ...
      <div className="landing-page">
        ...
        <div className={`sticky-cta ${showStickyCTA ? 'visible' : ''}`} data-testid="sticky-cta">
          <div className="sticky-cta-content">
            <span className="sticky-cta-text">Ready to find clarity?</span>
            <button 
