...
const HoroscopeScreen = () => {
  ...
  return (
    <div className="h-full bg-white">
      {/* Header */}
      <div className="px-4 pt-2 pb-4 bg-gradient-to-b from-emerald-50 to-white">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                    ...
                    <Icon className={`w-4 h-4 ${isExpanded ? 'text-emerald-600' : 'text-gray-500'}`} />
                  </div>
                  <span className={`font-medium ${isExpanded ? 'text-emerald-700' : 'text-gray-700'}`}>
                    {category.title}
                  </span>
                </div>
                {isExpanded ? (
                ...
                <div className="px-4 pb-4">
                  <div className="pt-2 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-sm font-medium text-emerald-600">{category.score}%</span>
                    </div>
                    ...
                    <button className="mt-3 text-xs text-emerald-600 font-medium">
                      Read more
                    </button>
                  </div>
                </div>
