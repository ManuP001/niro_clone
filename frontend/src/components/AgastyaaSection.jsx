...
const NiroSection = () => {
  return (
    <section className="bg-gradient-to-b from-white to-emerald-50 py-20 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif text-gray-900 mb-6">
            Ask anything, let{' '}
            <span className="text-emerald-600 italic">Niro.AI</span> answer
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
            Niro.AI leverages the power of AI to personalise the astrology experience for you.
          </p>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed mt-4">
            Niro.AI can answer all questions related to your life such as relationships, career, education, health and so on.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-80 md:h-80">
            <div className="relative w-full h-full">
              {/* Dashed circle */}
              <div className="absolute inset-0 border-2 border-dashed border-emerald-300 rounded-full"></div>
              {/* Sun glow */}
              <div className="absolute inset-8 bg-gradient-to-br from-emerald-200 via-emerald-100 to-emerald-100 rounded-full opacity-80 blur-sm"></div>
              <div className="absolute inset-12 bg-gradient-to-br from-emerald-100 to-emerald-50 rounded-full"></div>
              {/* Inner decorative lines */}
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 200 200">
                <path d="M100 60 Q110 100 100 140" fill="none" stroke="#10b981" strokeWidth="1" opacity="0.5"/>
                <path d="M80 80 Q100 100 120 120" fill="none" stroke="#10b981" strokeWidth="1" opacity="0.5"/>
              </svg>
            </div>
          </div>
