  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="relative bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 md:p-12">
          {/* Premium Badge */}
          {current.isPremium && (
            <div className="absolute top-4 right-4 flex items-center gap-1 bg-emerald-600 text-white px-3 py-1 rounded-full text-xs font-medium">
