    ...
    <section className="bg-white py-20">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-4xl md:text-5xl font-serif text-gray-900 mb-12 text-center">
          Other features on <span className="text-emerald-600">Niro.AI</span>
        </h2>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Generate Reports */}
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 hover:shadow-xl transition-shadow duration-300">
