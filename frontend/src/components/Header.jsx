      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="/" className="flex items-center gap-1">
            <span className="text-xl font-semibold text-gray-900">Niro.AI</span>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Button 
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 rounded-full border-0"
            >
              Login / Sign-up
            </Button>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-200 px-4 py-4">
          <nav className="flex flex-col gap-4">
            ...
            <Button className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-full w-full">
              Login / Sign-up
            </Button>
            <div className="flex items-center gap-2 text-gray-600">
              <span className="text-sm">Download for:</span>
