    ...
    <section className="bg-white py-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-square max-w-md mx-auto relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-48 h-48 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-full opacity-60"></div>
              </div>
              ...
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
                <path d="M80 100 Q200 200 320 100" fill="none" stroke="#10b981" strokeWidth="1" strokeDasharray="5,5" opacity="0.5"/>
                <path d="M80 100 Q200 250 200 300" fill="none" stroke="#10b981" strokeWidth="1" strokeDasharray="5,5" opacity="0.5"/>
                <path d="M320 100 Q200 250 200 300" fill="none" stroke="#10b981" strokeWidth="1" strokeDasharray="5,5" opacity="0.5"/>
              </svg>
            </div>
          </div>
          ...
          {/* Right Content */}
          <div>
            <p className="text-emerald-600 font-medium mb-2">Compatibility</p>
