...
class ConversationOrchestrator:
    ...
    NOTE: This is a legacy orchestrator using AstroEngine (stubbed data).
    Use EnhancedOrchestrator for production - it uses real Vedic API calls.
    """
    ...
    def __init__(
        ...
        logger.warning("ConversationOrchestrator initialized (LEGACY - use EnhancedOrchestrator instead)")
    ...
    async def process_message(
        ...
        # Legacy orchestrator does not compute astro features
        # Use EnhancedOrchestrator instead for real Vedic API integration
        astro_features = {}
